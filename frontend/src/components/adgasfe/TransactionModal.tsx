...
export function TransactionModal({ isOpen, transaction, statusMessage }: TransactionModalProps) {
  const { t } = useLocale();
      ...
      <div className="bg-[#1e293b] rounded-3xl max-w-md w-full overflow-hidden border border-[rgba(99,102,241,0.3)] shadow-[0px_0px_40px_0px_rgba(99,102,241,0.4)]">
        ...
        <div className="p-8 flex flex-col items-center gap-6">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-[#94a3b8]">{statusMessage ?? t('txModal.pleaseWait')}</p>
          </div>
